...
/**
 * AirPlayerApp — The Application class for AirPlayer.
 *
 ...
 * at startup.
 *
 * HOW: This class is referenced in AndroidManifest.xml via android:name=".AirPlayerApp".
 ...
 *   The app starts → Android creates AirPlayerApp → onCreate() runs → Timber is ready.
 */
class AirPlayerApp : Application() {
