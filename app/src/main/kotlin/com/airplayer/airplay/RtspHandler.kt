...
import com.airplayer.airplay.handshake.FairPlay
import com.airplayer.airplay.handshake.InfoResponder
import com.airplayer.airplay.handshake.PairingKeys
import com.airplayer.airplay.handshake.PairingSession
...
open class RtspHandler(
    ...
    private val onPlaybackInfo: () -> com.airplayer.airplay.PlaybackInfo? = { null },
    ...
    private val pairingStore: com.airplayer.airplay.handshake.PairingStore? = null,
    ...
    @Volatile private var legacyPin: com.airplayer.airplay.handshake.LegacyPairSetupPin? = null
     ...
     * could otherwise fail with EADDRINUSE, leaving AirPlayer advertising over mDNS while port 7000
    ...
    private fun handleServerInfo(request: RtspRequest): RtspResponse {
        val info = mapOf(
            "deviceid" to com.airplayer.util.NetworkUtils.getMacAddress(),
    ...
    private fun newSrpSession() {
        ...
        onShowPin(pin)
        legacyPin = com.airplayer.airplay.handshake.LegacyPairSetupPin(pin, PairingKeys.get(context).edPublic)
    }
    ...
    companion object {
        ...
        private const val SESSION_ID = "AirPlayerSession"
