 ...
 *
 * The mirror video server ([com.airplayer.airplay.handshake.MirrorStreamServer]) and audio server
 * ([com.airplayer.airplay.handshake.AudioStreamServer]) write these volatile fields as they run;
 * [com.airplayer.ui.StreamingScreen] polls [summary] a few times a second to render the HUD. Plain
 * volatile ints keep the hot path allocation-free — no flows or locks on the per-frame path.
 *
 * [overlayEnabled] is set from [com.airplayer.settings.AppSettings.showDebugOverlay] when the AirPlay
