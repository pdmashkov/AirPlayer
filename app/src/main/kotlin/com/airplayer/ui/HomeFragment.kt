...
class HomeFragment : Fragment() {
    ...
    // Service binding — gives direct access to AirPlayerService StateFlows
    ...
    private val serviceConnection = object : ServiceConnection {
        override fun onServiceConnected(name: ComponentName?, binder: IBinder?) {
            ...
            isBound = true
            Logger.d("HomeFragment: bound to AirPlayerService")
            observeServiceState()
        }
        ...
        override fun onServiceDisconnected(name: ComponentName?) {
            service = null
            isBound = false
            Logger.d("HomeFragment: unbound from AirPlayerService")
        }
    }
    ...
    override fun onStart() {
        ...
        val intent = Intent(requireContext(), AirPlayerService::class.java)
     ...
     * Calls [ServiceController] which sends Intent actions to [AirPlayerService].
     */
    ...
    /**
     * Starts collecting state updates from [AirPlayerService].
