...
/**
 * Logger — A thin wrapper around Timber for AirPlayer-specific logging.
 *
 * WHY: Using a wrapper instead of calling Timber directly gives us two benefits:
 * 1. We can add AirPlayer-specific behavior in one place (e.g., scrubbing IP addresses
 ...
 * Timber must be initialized in AirPlayerApp.onCreate() before Logger is used.
 *
 * Example:
