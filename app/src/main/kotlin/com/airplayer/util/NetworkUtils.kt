...
object NetworkUtils {
     ...
     * 3. Fallback: "AirPlayer" (if neither source is available)
     *
    ...
    // Constants
    private const val DEFAULT_DEVICE_NAME = "AirPlayer"
    private const val FALLBACK_MAC_ADDRESS = "aa:bb:cc:dd:ee:ff"
    private const val PREFS_NAME = "airplayer_prefs"
    private const val PREF_KEY_DEVICE_UUID = "airplayer_device_uuid"
}
